...
import { createYupSchema, flattenRecursiveArray } from "./helpers";
import { useAppDispatch, useAppSelector } from "hooks";
import { SET_PERSON } from "store";
import { routes } from "constants/routes";
import { Person, RecursiveFieldArray } from "types";
...
export const Index: FC<IndexProps> = ({ fieldSet }) => {
  ...
  const validationSchema = yup.object().shape(createYupSchema(flattenRecursiveArray(fieldSet)));
